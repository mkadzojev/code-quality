...
namespace ToolkitCodingStandards\Sniffs;

use ToolkitCodingStandards\CodeSniffer\CodeError;
use ToolkitCodingStandards\CodeSniffer\CodeWarning;
use ToolkitCodingStandards\CodeSniffer\Helper\ExceptionHelper;
