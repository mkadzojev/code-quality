...
namespace ToolkitCodingStandards\Sniffs\Functions;

use ToolkitCodingStandards\CodeSniffer\Helper\PropertyHelper;
use ToolkitCodingStandards\CodeSniffer\Helper\TokenHelper;
use ToolkitCodingStandards\Sniffs\AbstractSniff;
use ToolkitCodingStandards\Sniffs\ClassRegistrationTrait;
...
class ForceAttributeCastingSniff extends AbstractSniff
{
    ...
    private const NAME = 'ToolkitCodingStandards.Functions.ForceAttributeCasting';
