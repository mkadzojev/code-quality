...
namespace Toolkit\Quality\Commands;

use Illuminate\Console\Command;

class QualityInstallCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'quality:install';
     ...
     * @var string
     */
    protected $description = 'Installs the quality package';
